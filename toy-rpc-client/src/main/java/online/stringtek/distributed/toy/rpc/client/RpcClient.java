package online.stringtek.distributed.toy.rpc.demo.consumer.client;
...
import online.stringtek.distributed.toy.rpc.demo.consumer.client.handler.RpcResponseHandler;
...
public class RpcClient {
    ...
    public static <T> T proxy(RpcRequest rpcRequest) throws InterruptedException {
